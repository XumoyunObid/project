...
const TermsOfService = () => {
  return (
    <div className="py-4 md:px-[100px] lg:px-[150px]">
      <h1 className="text-[28px] text-center">Terms of service</h1>
      <div className="my-6">
        <h2 className="text-xl text-gray-700 my-3">Overview</h2>
        <p className="text-md text-gray-500">
          This website is operated by Tokyo Camii Gift. Throughout the site, the
          terms “we”, “us” and “our” refer to Tokyo Camii Gift. Tokyo Camii Gift
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          any part or content thereof) without notice at any time. <br /> We
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          computer monitor's display of any color will be accurate. <br /> We
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          placed by dealers, resellers or distributors. <br /> <br /> You agree
          ...
          <br /> For more details, please review our Refund Policy: [LINK TO
          REFUND POLICY]
        </p>
      </div>
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          <br /> We may, but have no obligation to, monitor, edit or remove
          ...
          or these Terms of Service. <br /> You agree that your comments will
          ...
          right. You further agree that your comments will not contain libelous
          or otherwise unlawful, abusive or obscene material, or contain any
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          notice (including after you have submitted your order). <br /> We
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          be accurate or reliable. <br /> You agree that from time to time we
          may remove the Service for indefinite periods of time or cancel the
          Service at any time, without notice to you. <br /> You expressly agree
          that your use of, or inability to use, the Service is at your sole
          risk. The Service and all products and Services delivered to you
          ...
          title, and non-infringement. In no case shall Tokyo Camii Gift, our
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          You agree to indemnify, defend and hold harmless Tokyo Camii Gift and
      ...
      <div className="my-6">
        <h2 className="text-xl text-gray-700 my-3">SECTION 16 - TERMINATION</h2>
        <p className="text-md text-gray-500">
      ...
      <div className="my-6">
        ...
        <p className="text-md text-gray-500">
          ...
          halalmarket2020@gmail.com. <br /> Our contact information is posted
          below: <br />
          [INSERT TRADING NAME] <br /> halalmarket2020@gmail.com <br /> [INSERT
          BUSINESS ADDRESS] <br /> [INSERT BUSINESS PHONE NUMBER] <br /> [INSERT
